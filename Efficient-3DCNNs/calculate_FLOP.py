...
# model = shufflenetv2.get_model( width_mult=1.0, num_classes=9, sample_size = 112)#6
...
# model = mobilenetv2.get_model( width_mult=1.0, num_classes=9, sample_size = 112)#16
# model = squeezenet.get_model( version=1.1, num_classes=9, sample_size = 112, sample_duration = 16)
model = resnext.resnext101( num_classes=9, shortcut_type='B', cardinality=32, sample_size=112, sample_duration=16)
# model = resnet.resnet18( num_classes=9, shortcut_type='A', sample_size=112, sample_duration=16)
# model = resnet.resnet50( num_classes=9, shortcut_type='B', sample_size=112, sample_duration=16)
# model = resnet.resnet101( num_classes=9, shortcut_type='B', sample_size=112, sample_duration=16)
# model = c3d.get_model( num_classes=9, sample_size=112, sample_duration=16)
model = model.cuda()
