...
def launch_training_job(pretrain_path, learning_rate):
    ...
    print(model_name)
    print(model_width)
    result_name = model_name + "_" + model_width  + "_" + str(50) + "_" +"ccrop"
    ...
    if model_name == 'resnet' or model_name == 'resnext':
        ...
        cmd = "python main.py --root_path /home/shared/workspace/ \
            --video_path Resnet3D/3D-ResNets-PyTorch/our_data/jpg \
            --annotation_path Resnet3D/3D-ResNets-PyTorch/our_data/ntutest.json \
