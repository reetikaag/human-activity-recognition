...
### Preprocess data
Preprocess NTU RGB+D data - Resnet3D/Data_preprocessing.ipynb
Preprocess our own self-collected data - Efficient-3DCNNs/Our_test_set_preprocessing.ipynb
### Generate jpg, json files and n_frames
Use the following file for generating jpg and json files - Resnet3D/genjpgandjson.sh
...
For both NTU RGB+D dataset and our own data - Efficient-3DCNNs/Data_visualization.ipynb
...
```
### To evaluate accuracy metrics
Accuracy, Precision, Recall, Confusion matrix - Efficient-3DCNNs/Evaluate_metrics.ipynb/
...
## Paper Results
<p align="center"><img src="https://github.com/reetikaag/human-activity-recognition/blob/main/Efficient-3DCNNs/result_images/loss.png" align="left" width="900" title="Loss of training and validation for a sample model (ResNeXt-101)" /></p>

<p align="center"><img src="https://github.com/reetikaag/human-activity-recognition/blob/main/Efficient-3DCNNs/result_images/accuracy.png" align="right" width="900" title="Accuracy of training and validation for a sample model (ResNeXt-101)" /></p>

<p align="center"><img src="https://github.com/reetikaag/human-activity-recognition/blob/main/Efficient-3DCNNs/result_images/learning_rate.png" align="left" width="900" title="Results of pre-training for action recognition task" /></p>
...
<p align="center"><img src="https://github.com/reetikaag/human-activity-recognition/blob/main/Efficient-3DCNNs/result_images/model_depth.png" align="middle" width="900" title="Effect of model depth on accuracy for ResNet 3D" /></p>
...
<p align="center"><img src="https://github.com/reetikaag/human-activity-recognition/blob/main/Efficient-3DCNNs/result_images/saliency_map.pdf" align="middle" width="900" title="Saliency Map for ResNet-101" /></p>
